...
class _QuizPlayState extends State<QuizPlay> {
 late QuerySnapshot questionSnaphot;
  ...
  @override
  void initState() {
    databaseService.getQuestionsData(widget.quizId).then((value) {
...
class QuizPlay extends StatefulWidget {
  ...
  final String quizId;
  const QuizPlay(this.quizId, {Key? key}) : super(key: key);
